<template>
  <UCard>
    <template #header>
      ...
      <p class="text-center text-gray-600 text-sm mt-2">Enter your new password below</p>
    </template>
...
import { resetPasswordHandler2 } from '~/composables/api/sdk.gen'
...
const onSubmit = async () => {
  ...
  try {
    const { error } = await resetPasswordHandler2({
      body: {
