...
export type CreateFairResponse = {
    fair_id: number;
};
...
export type GroupFairReport = {
    bought: Array<PurchaseEntry>;
    fair_id: number;
    group_id: number;
    group_name: string;
    min_purchases_required: number;
    purchases_fulfilled: boolean;
    sold: Array<SaleEntry>;
};
...
export type PurchaseRequest = {
    buyer_group_id: number;
    group_deliverable_component_id: number;
    seller_group_deliverable_selection_id: number;
};
...
export type CreateFairHandlerErrors = {
    /**
     * Invalid request data
     */
    400: JsonError;
    /**
     * A fair already exists for this project
     */
    409: JsonError;
    /**
     * Internal server error
...
export type CreateFairHandlerError = CreateFairHandlerErrors[keyof CreateFairHandlerErrors];

export type CreateFairHandlerResponses = {
    /**
     * Fair created successfully
     */
    201: CreateFairResponse;
};

export type CreateFairHandlerResponse = CreateFairHandlerResponses[keyof CreateFairHandlerResponses];

export type GetFairByProjectHandlerData = {
    body?: never;
    path: {
        /**
         * Project ID
...
export type GetFairByProjectHandlerErrors = {
    /**
     * No fair for this project
     */
    404: JsonError;
    /**
     * Internal server error
...
export type GetFairByProjectHandlerError = GetFairByProjectHandlerErrors[keyof GetFairByProjectHandlerErrors];

export type GetFairByProjectHandlerResponses = {
    /**
     * Fair for the project
     */
    200: FairResponse;
};

export type GetFairByProjectHandlerResponse = GetFairByProjectHandlerResponses[keyof GetFairByProjectHandlerResponses];

export type GetFairHandlerData = {
    body?: never;
    path: {
        /**
         * Fair ID
...
export type GetFairHandlerErrors = {
    /**
     * Fair not found
     */
    404: JsonError;
...
export type GetFairHandlerError = GetFairHandlerErrors[keyof GetFairHandlerErrors];

export type GetFairHandlerResponses = {
    /**
     * Fair details
     */
    200: FairResponse;
...
export type GetFairHandlerResponse = GetFairHandlerResponses[keyof GetFairHandlerResponses];

export type UpdateFairHandlerData = {
...
export type UpdateFairHandlerErrors = {
    /**
     * Invalid request data
     */
    400: JsonError;
...
export type UpdateFairHandlerError = UpdateFairHandlerErrors[keyof UpdateFairHandlerErrors];

export type UpdateFairHandlerResponses = {
    /**
...
export type DisableFairHandlerData = {
    body?: never;
    path: {
        /**
         * Fair ID
...
export type DisableFairHandlerErrors = {
    /**
     * Fair not found
     */
    404: JsonError;
...
export type DisableFairHandlerError = DisableFairHandlerErrors[keyof DisableFairHandlerErrors];

export type DisableFairHandlerResponses = {
    /**
     * Fair disabled — end_date set to now
     */
    200: unknown;
};

export type EnableFairHandlerData = {
    body?: never;
    path: {
        /**
         * Fair ID
...
export type EnableFairHandlerErrors = {
    /**
     * end_date is in the past; update dates first
     */
    400: JsonError;
    /**
     * Fair not found
...
export type EnableFairHandlerError = EnableFairHandlerErrors[keyof EnableFairHandlerErrors];

export type EnableFairHandlerResponses = {
    /**
     * Fair enabled — start_date set to now
     */
    200: unknown;
};

export type FairReportHandlerData = {
    body?: never;
    path: {
        /**
         * Fair ID
    ...
    query: {
        /**
         * Group ID to generate the report for
         */
        group_id: number;
    };
...
export type FairReportHandlerErrors = {
    /**
     * Fair or group not found
     */
    404: JsonError;
    /**
     * Internal server error
...
export type FairReportHandlerError = FairReportHandlerErrors[keyof FairReportHandlerErrors];

export type FairReportHandlerResponses = {
    /**
     * Sales report for the group
     */
    200: GroupFairReport;
};

export type FairReportHandlerResponse = FairReportHandlerResponses[keyof FairReportHandlerResponses];
...
export type LeaderboardHandlerData = {
    body?: never;
    path: {
        /**
         * Fair ID
    ...
    query?: never;
    url: '/v1/fairs/{fair_id}/leaderboard';
};

export type LeaderboardHandlerErrors = {
    /**
     * Fair not found
     */
    404: JsonError;
...
export type LeaderboardHandlerError = LeaderboardHandlerErrors[keyof LeaderboardHandlerErrors];

export type LeaderboardHandlerResponses = {
    /**
     * Sales leaderboard for the fair
     */
    200: LeaderboardResponse;
};

export type LeaderboardHandlerResponse = LeaderboardHandlerResponses[keyof LeaderboardHandlerResponses];
...
export type ListTransactionsHandlerData = {
    body?: never;
    path: {
        /**
         * Fair ID
...
export type ListTransactionsHandlerErrors = {
    /**
...
export type ListTransactionsHandlerError = ListTransactionsHandlerErrors[keyof ListTransactionsHandlerErrors];

export type ListTransactionsHandlerResponses = {
    /**
     * List of transactions made by the group
     */
    200: ListTransactionsResponse;
};

export type ListTransactionsHandlerResponse = ListTransactionsHandlerResponses[keyof ListTransactionsHandlerResponses];

export type PurchaseHandlerData = {
...
export type PurchaseHandlerErrors = {
    /**
     * Validation error
     */
    400: JsonError;
    /**
     * Not a group leader or fair not active
     */
    403: JsonError;
    /**
     * Fair, selection, or component not found
     */
    404: JsonError;
    /**
     * Already purchased this component from this group
     */
    409: JsonError;
    /**
     * Internal server error
...
export type PurchaseHandlerError = PurchaseHandlerErrors[keyof PurchaseHandlerErrors];

export type PurchaseHandlerResponses = {
    /**
     * Purchase recorded
     */
...
export type PurchaseHandlerResponse = PurchaseHandlerResponses[keyof PurchaseHandlerResponses];
